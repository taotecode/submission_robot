...
trait AuditorRoleCheckService
{
     ...
     * 检查用户是否是审核成员和审核组成员
     */
    public function baseCheck(Api $telegram, int|string $callbackQueryId, int|string $userId, int|string $reviewGroupId, bool $isReply = false, string|int|null $messageId = null): bool|string
    {
        //检查用户是否是审核成员
     ...
     * 检查用户的审核角色的权限
     */
    public function roleCheck(Api $telegram, int|string $callbackQueryId, int|string $userId, array $roles, bool $isReply = false, string|int|null $messageId = null): bool|string
    {
