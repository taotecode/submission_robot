...
class AdminMenuAddSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['id' => 13, 'parent_id' => 0, 'order' => 1, 'title' => '配置表', 'icon' => 'fa-bullhorn', 'uri' => '/config', 'extension' => '', 'show' => 1, 'created_at' => '2023-08-30 06:28:08', 'updated_at' => '2023-08-30 06:28:08'],
            ...
            ['id' => 17, 'parent_id' => 0, 'order' => 17, 'title' => '机器人消息', 'icon' => 'fa-users', 'uri' => '/bot_message', 'extension' => '', 'show' => 1, 'created_at' => '2023-08-30 06:28:08', 'updated_at' => '2023-08-30 06:28:08'],
        ];
