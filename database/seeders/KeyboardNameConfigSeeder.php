    ...
    public function run()
    {
        $data = [
            ...
            [
                ...
                'name' => 'ConfirmSubmissionOpen',
                'value' => "确认投稿（公开）",
                'description' => '用户选择频道后结束投稿键盘-确认投稿（公开）',
                'created_at' => '2023-09-17 08:12:22',
                'updated_at' => '2023-09-17 08:12:22',
            ],
            [
                ...
                'name' => 'ConfirmSubmissionAnonymous',
                'value' => "确认投稿（匿名）",
                'description' => '用户选择频道后结束投稿键盘-确认投稿（匿名）',
                'created_at' => '2023-09-17 08:12:22',
                'updated_at' => '2023-09-17 08:12:22',
            ],
            [
                ...
                'name' => 'Restart',
                'value' => "重新开始",
                'description' => '用户选择频道后结束投稿键盘-重新开始',
                'created_at' => '2023-09-17 08:12:22',
                'updated_at' => '2023-09-17 08:12:22',
            ],
            [
                ...
                'name' => 'CancelSubmission',
                'value' => "取消投稿",
                'description' => '用户选择频道后结束投稿键盘-取消投稿',
                'created_at' => '2023-09-17 08:12:22',
                'updated_at' => '2023-09-17 08:12:22',
            ],
            [
